...
namespace DeviceEmulator.Models
{
    ...
    public class DeviceWebAPIParameters
    {
        ...
        public void Fix()
        {
            IotConnection = fixStringProperty(ConfigurationManager.ConnectionStrings["iotHubConnectionString"].ConnectionString, IotConnection);
            EhubConnection = fixStringProperty(ConfigurationManager.ConnectionStrings["eventHubConnectionString"].ConnectionString, EhubConnection);
            EhubStorage = fixStringProperty(ConfigurationManager.ConnectionStrings["eventHubStorage"].ConnectionString, EhubStorage);
            Interval = fixIntProperty(Interval, ConfigurationManager.AppSettings["interval"]);
            Iterations = fixIntProperty(Iterations, ConfigurationManager.AppSettings["interval"]);
            HubName = fixStringProperty(ConfigurationManager.AppSettings["eventHubName"], HubName);
            EventReceiveDelay = fixIntProperty(EventReceiveDelay, ConfigurationManager.AppSettings["eventReceiveDelay"]);
        }
